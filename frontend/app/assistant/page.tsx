            ...
            messages.map((msg) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Message Bubble / Card */}
                  <div
                    className={`rounded-2xl shadow-xl leading-relaxed transition-all ${
                      isUser
                        ? "max-w-2xl bg-teal-500 text-slate-950 rounded-tr-none p-4 font-medium text-sm"
                        : "w-full max-w-4xl bg-slate-950 text-slate-100 border border-slate-800 rounded-tl-none p-5 sm:p-6"
                    }`}
                  >
                    {/* Assistant Status Badges & Actions */}
                    {!isUser && (
                      <div className="mb-4 pb-3 border-b border-slate-800/80 flex items-center justify-between gap-3">
                        ...
                        <button
                          ...
                          className="px-2.5 py-1 rounded-lg text-slate-400 hover:text-teal-300 hover:bg-slate-900 border border-slate-800/80 transition-colors flex items-center gap-1.5 text-xs font-mono shrink-0 cursor-pointer"
                          title="Copy message"
                        >
                          {copiedId === msg.id ? (
                            <>
