      ...
      <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
        <form className="relative flex flex-1" action="#" method="GET">
          ...
          <input
            ...
            placeholder="Search documents, reports, and knowledge base..."
            type="search"
            name="search"
          />
        </form>
        <div className="flex items-center gap-x-4 lg:gap-x-6">
          ...
          <div className="hidden lg:flex lg:items-center lg:gap-x-3">
            ...
            {isHOD ? (
              <span className="inline-flex items-center gap-1 rounded-md bg-teal-50 px-2 py-1 text-xs font-semibold text-teal-700 ring-1 ring-inset ring-teal-700/10">
                <ShieldCheck className="h-3 w-3" /> HOD
              </span>
            ) : (
